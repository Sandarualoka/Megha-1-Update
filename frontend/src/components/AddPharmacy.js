...
function AddPharmacy() {
    ...
    useEffect(() => {
        ...
        fetch('http://localhost:4000/pharmacy-users')
    ...
    const handleToggle = async (userId) => {
        try {
          ...
          const response = await fetch(`http://localhost:4000/update-status/${userId}`, {
            method: 'PUT',
            headers: {
            ...
            <div>
                <div className='mt-[-30]'>
                    <div style={{ textAlign: "center" }}>
                        ...
                        <h1 className='text-5xl mt-10 font-bold '><span className='text-yellow-500'>PHARMACY</span> <span className='text-green-700'>LIST</span></h1>
